...
const Home = () => {
  return (
    <>
      ...
      <section className="px-[120px] bg-background items-center gap-6 py-10">
        <h1 className='text-secondary text-5xl font-bold text-center'>Our Services</h1>
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mt-2'>
          <div className='w-full text-center'>dfkgjgsdhjksdghljh</div>
          <div className='w-full text-center'>dfkgjgsdhjksdghljh</div>
          <div className='w-full text-center'>dfkgjgsdhjksdghljh</div>
          <div className='w-full text-center'>dfkgjgsdhjksdghljh</div>
        </div>
